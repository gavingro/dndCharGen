...
from character.character_sheet import get_char_info
from character.character_sheet import display
...
class TestCharacterSheet(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.wise_dwarf = Character(base_stats=Stats(DEX=17, WIS=18), race='Dwarf', game_class='Barbarian', background='Acolyte')
